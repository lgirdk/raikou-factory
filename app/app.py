...
async def update_file(request_data: UpdateFileRequest):
...
async def update_json_file(request_data: UpdateJsonFileRequest):
    """API endpoint to update a JSON file inside a Docker container.
